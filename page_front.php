...
get_header();
?>
<div class="glass glass-default" style="padding-top: 10%;text-align: center; width:100%; background-size: cover; background-attachment: fixed; display: block; height:700pt; background-color: #333; background-image: url('<?php echo get_theme_mod('front_image_url')?>')">
    <div class="glass-content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12" style="font-size: 20pt">
                    <p><?php the_excerpt();?></p>
                </div>
            </div>
        <?php endwhile;?>
